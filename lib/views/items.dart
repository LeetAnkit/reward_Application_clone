...
class Item {
  ...
  Item({required this.image, required this.label, required this.point, required this.description}); // Added 'required' to parameters
}

class ItemList extends StatelessWidget {
  const ItemList({Key? key, required this.label}) : super(key: key); // Added null safety and 'required'
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      ...
                      style: Theme.of(context).textTheme.titleSmall,   //subtitle2 -> titleSmall
                      maxLines: 2,
                      textAlign: TextAlign.center,
                      overflow: TextOverflow.ellipsis,
                    ),
